...
- [2026-03-20 16:29] 今天 12 點才起床，教學怪物中午已開完
- [2026-03-20 16:31] 下週一：NTUAIS 活動，需備課（讀文章）+ 場地 + 錄取問題
...
- [2026-03-21 03:55] NTUAIS 會議移到週五晚（本週已開完），討論了 technical track 頻率（維持每週）、成員分組、grant 申請
- [2026-03-21 21:53] 本週六晚沒有 AIS meeting（已提前到週五開完）
...
- [03/20 05:34] Decision: memory_search_local.py → keep but no further investment, rely on CC + grep
