...
- Pathfinder：需改 grant budget + follow up（今天 deadline）
- 實驗室 AI 帳號共享方案：宏毅老師認可，下週發布
- 15:00 第二階段專題 meeting（奕豪）
- 玉山：Leo 決定參加
- battleship 已恢復；iso_leo 維修中
- 被奇恩訓話：太依賴 AI 操作 NAS

## Pending Decisions
- 僑生獎助學金衝突：待寫信僑委會確認
- 研究方向：metric optimization vs mechanistic interp（Leo 仍在思考）
