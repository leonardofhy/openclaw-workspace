...
\textbf{Claim 6:} t* (collapse onset) combined with SAE incrimination provides a two-level attribution system for grounding failure: t* identifies \textit{when} collapse occurs, and feature blame identifies \textit{which features} are responsible.
